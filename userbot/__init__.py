...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/jkthe1/MiX.git")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "jk")    
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "MiX")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/9d26d75bd4e20b1ed9f32.jpg"    
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("I'm [MiX](https://github.com/jkthe1/MiX) modules helper...\nplease make your own bot, don't use mine 😋")
            else:
